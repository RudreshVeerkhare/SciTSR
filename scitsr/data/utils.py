...
def add_knn_edges(chunks, relations, k=20, debug=False):
    ...
    Here relations are just being used for getting ids of chunks  
    id of chunk is just an index of chuck in chunk file

    While inference we can pass relations as an empty list
    """
    edges = set()
    rel_recall = {}
